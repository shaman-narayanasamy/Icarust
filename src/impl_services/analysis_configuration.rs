...
use crate::services::minknow_api::analysis_configuration::{
    analysis_configuration_service_server::AnalysisConfigurationService, AnalysisConfiguration,
    EventDetection, GetAnalysisConfigurationRequest, GetReadClassificationsRequest,
    GetReadClassificationsResponse, ReadDetectionParams,
};
#[derive(Debug)]
pub struct Analysis();
...
impl AnalysisConfigurationService for Analysis {
    ...
    async fn get_read_classifications(
        ...
        let class_map = HashMap::from([
            ...
            (68, "unknown_negative".to_string()),
            (69, "event".to_string()),
            (70, "unknown_positive".to_string()),
    ...
    async fn get_analysis_configuration(
        ...
        Ok(Response::new(AnalysisConfiguration {
            event_detection: Some(EventDetection { window_size: 0 }),
